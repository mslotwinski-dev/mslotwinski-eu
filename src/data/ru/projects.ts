...
AnalyseMe задуман как ваш личный центр самопознания — от многоосевого политического анализа до тестов на личную свободу — без ненужных сложностей и барьеров.`,
      ...
      {
        title: 'Lightning',
        description: 'Простое приложение для хранения и сокращения ваших ссылок.',
...
Безопасность и конфиденциальность лежат в основе poCHATo. Прямое общение ограничено взаимно принятыми друзьями.`,
  ...
  },
  {
    ...
    projects: [
      {
        title: 'Assistant',
        description: 'Современное веб-приложение, предназначенное для интерактивного просмотра учебных программ и структур факультетов. Здесь с плейсхолдером — Королевским технологическим институтом.',
...
Кроме того, проект позволяет расширить панель администратора в реальном времени и правила маршрутизации.`,
      ...
      {
        title: 'Neon',
        description:'Neon — это платформа распределенных вычислений, предназначенная для моделирования и обработки научных данных в средах HPC.',
        longdescription:
  ...
  },
  {
    ...
    projects: [
      {
        title: 'Arctic',
        description: 'Минималистичная модульная 32-битная операционная система, написанная на C и NASM для архитектуры x86.', 
      ...
      {
        title: 'Echo',
        description: 'Echo — это модульный фреймворк для обработки и анализа цифровых сигналов. Позволяет загружать данные, фильтровать и визуализировать.',
