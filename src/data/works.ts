...
export const works: Work[] = [
  {
    ...
    Tasks: [
      ...
      'Administracja serwerami i obsługa API oraz baz danych. Obsługa problemów i wsparcie techniczne klientów.',
    ],
  },
  {
    Name: 'Techgroup',
    Position: 'Technik telekomunikacji',
    HowLong: '08.2025 - 09.2025',
    Tasks: [
      'Układanie i montaż kabli światłowodowych. Serwisowanie i konserwacja sieci telekomunikacyjnych.',
      'Konfiguracja i utrzymywanie urządzeń sieciowych oraz domowych sieci internetowych.',
      'Programowanie usług i aplikacji sieciowych. ',
    ],
  },
  {
